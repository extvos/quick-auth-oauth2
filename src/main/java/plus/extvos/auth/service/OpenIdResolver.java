...
public interface OpenIdResolver {
     ...
     * @param unionId   from authenticator
     ...
     */
    OAuthInfo resolve(String provider, String openId, String unionId, Serializable userId, Map<String, Object> params) throws ResultException;
     ...
     * @throws ResultException on error
     */
    OAuthInfo register(String provider, String openId, String unionId, String username, String password, Map<String, Object> params) throws ResultException;
     ...
     * @param unionId   as string
     * @param userId   as user Id
     * @param params   parameters from provider.
     * @return UserInfo of updated.
     * @throws ResultException when error.
     */
    OAuthInfo update(String provider, String openId, String unionId, Serializable userId, Map<String, Object> params) throws ResultException;
}
